...
namespace ProgrammingAssignment2
{
    ...
    public class Egg
    {
        ...
        {
            if (howCooked != HowCooked.NotCooked && howCooked != HowCooked.HardBoiled)
            {
            ...
            else if (howCooked == HowCooked.HardBoiled)
            {
                amountLeft = 9;
            }
            if (size > amountLeft)
        ...
        {
            if(this.color == EggColor.White && this.color == EggColor.Blue)
            {
               this.color = color;
            }
        }
